...
DSpark 验证项目。当前发行版为 **2026.08.30-r2.2**；R1 与更早现场版本仍完整
...
已经加载精确 `2026.08.26-r2` 镜像的目标机不必重新传输完整镜像，可使用 R2.2
增量包执行：
...
| 项目 | 固定值 |
|---|---|
| Release | `2026.08.30-r2.2` |
| vLLM source | `6683c3dc41936a0a5b15d73db056388abddbf8a8` |
| CUDA 架构 | SM80 / A100 |
| GPU / TP | 8 / 8 |
