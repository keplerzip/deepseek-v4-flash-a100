...
class Transition:
    ...
    # Commit a name-validated recovery only on this transition.  Until this
    # point the engine retains the raw candidate so a truncated/malformed
    # invoke can be restored as ordinary text without emitting tool events.
